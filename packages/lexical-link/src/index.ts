 ...
 */
export function $createLinkNode(url: string, attributes?: LinkAttributes, key?: string): LinkNode {
	return $applyNodeReplacement(new LinkNode(url, attributes, key))
}
...
export class AutoLinkNode extends LinkNode {
	...
	constructor(url: string, attributes: AutoLinkAttributes = {}, key?: NodeKey) {
		...
		this.__isUnlinked =
			attributes.isUnlinked !== undefined && attributes.isUnlinked !== null ? attributes.isUnlinked : false
	}
 ...
 * @returns The LinkNode.
 */
export function $createAutoLinkNode(url: string, attributes?: AutoLinkAttributes, key?: string): AutoLinkNode {
	return $applyNodeReplacement(new AutoLinkNode(url, attributes, key))
}
