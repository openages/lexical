...
function errorOnNodeKeyConstructorMismatch(node: LexicalNode, existingKey: NodeKey) {
...
export function isTab(key: string, altKey: boolean, ctrlKey: boolean, metaKey: boolean): boolean {
	return key === 'Tab' && !altKey && !ctrlKey && !metaKey
}

export function isBold(key: string, altKey: boolean, metaKey: boolean, ctrlKey: boolean): boolean {
	return key.toLowerCase() === 'b' && !altKey && controlOrMeta(metaKey, ctrlKey)
}

export function isItalic(key: string, altKey: boolean, metaKey: boolean, ctrlKey: boolean): boolean {
	return key.toLowerCase() === 'i' && !altKey && controlOrMeta(metaKey, ctrlKey)
}

export function isUnderline(key: string, altKey: boolean, metaKey: boolean, ctrlKey: boolean): boolean {
...
export function isDeleteWordBackward(key: string, altKey: boolean, ctrlKey: boolean): boolean {
	return isBackspace(key) && (IS_APPLE ? altKey : ctrlKey)
}

export function isDeleteWordForward(key: string, altKey: boolean, ctrlKey: boolean): boolean {
...
export function isDeleteBackward(key: string, altKey: boolean, metaKey: boolean, ctrlKey: boolean): boolean {
	if (IS_APPLE) {
		if (altKey || metaKey) {
			return false
		}
...
export function isUndo(key: string, shiftKey: boolean, metaKey: boolean, ctrlKey: boolean): boolean {
	return key.toLowerCase() === 'z' && !shiftKey && controlOrMeta(metaKey, ctrlKey)
}

export function isRedo(key: string, shiftKey: boolean, metaKey: boolean, ctrlKey: boolean): boolean {
	if (IS_APPLE) {
...
export function isCopy(key: string, shiftKey: boolean, metaKey: boolean, ctrlKey: boolean): boolean {
	if (shiftKey) {
		return false
	}
...
export function isCut(key: string, shiftKey: boolean, metaKey: boolean, ctrlKey: boolean): boolean {
	if (shiftKey) {
		return false
	}
...
export function isMoveBackward(key: string, ctrlKey: boolean, altKey: boolean, metaKey: boolean): boolean {
...
export function isMoveForward(key: string, ctrlKey: boolean, altKey: boolean, metaKey: boolean): boolean {
...
export function isMoveUp(key: string, ctrlKey: boolean, metaKey: boolean): boolean {
	return isArrowUp(key) && !ctrlKey && !metaKey
}

export function isMoveDown(key: string, ctrlKey: boolean, metaKey: boolean): boolean {
...
export function isSelectAll(key: string, metaKey: boolean, ctrlKey: boolean): boolean {
...
type ShadowRootNode = Spread<{ isShadowRoot(): true; [ShadowRootNodeBrand]: never }, ElementNode>
