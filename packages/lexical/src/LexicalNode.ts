...
export class LexicalNode {
	...
	getNodesBetween(targetNode: LexicalNode): Array<LexicalNode> {
		...
		while (true) {
			...
			const nextSibling: LexicalNode | null = isBefore ? node.getNextSibling() : node.getPreviousSibling()
			if (nextSibling !== null) {
				node = nextSibling
				continue
			}
 ...
 */
export function insertRangeAfter(node: LexicalNode, firstToInsert: LexicalNode, lastToInsert?: LexicalNode) {
