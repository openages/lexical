...
import { useCallback, useEffect, useMemo, useRef, useState, MutableRefObject, ReactPortal } from 'react'
	...
	const positionMenu = useCallback(() => {
		...
		if (rootElement !== null && resolution !== null) {
			...
			if (menuEle !== null) {
				...
				if (showOnTop) {
					containerDiv.style.top = `${top + window.scrollY - anchorHeight - menuHeight + 6}px`
				}
